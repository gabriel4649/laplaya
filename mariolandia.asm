<<<<<<< /home/jaime/repos/playa/laplaya/mariolandia.asm.orig.204597271
<<<<<<< /home/jaime/repos/playa/laplaya/moveQ.asm.orig.816124812
...
>>>>>>> /tmp/moveQ.asm~other.atDiub
||||||| /tmp/moveQ.asm~base.aLGiGX
Title subrutina que mueve un caracter en la pantalla por un delta X y delta Y
.model small
.stack 100h
.data
...
>>>>>>> /tmp/mariolandia.asm~other.bqKbYV
